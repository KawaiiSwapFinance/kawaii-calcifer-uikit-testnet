...
var Icon$23 = function (props) {
    var theme = useTheme();
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 28 28" }, props),
        React__default['default'].createElement("image", { width: "28", height: "28", href: theme.isDark ? '/images/kawaii/icons/Games_dark.png' : "/images/kawaii/icons/Games.png" })));
};

var Icon$24 = function (props) {
    var theme = useTheme();
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 28 28" }, props),
        React__default['default'].createElement("image", { width: "28", height: "28", href: theme.isDark ? '/images/kawaii/icons/BtcPrediction_dark.png' : "/images/kawaii/icons/BtcPrediction.png" })));
};

var Icon$25 = function (props) {
    var theme = useTheme();
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 28 28" }, props),
        React__default['default'].createElement("image", { width: "28", height: "28", href: theme.isDark ? '/images/kawaii/icons/Charts_dark.png' : "/images/kawaii/icons/Charts.png" })));
};

var Icon$26 = function (props) {
    var theme = useTheme();
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 28 28" }, props),
        React__default['default'].createElement("image", { width: "28", height: "28", href: theme.isDark ? '/images/kawaii/icons/Listings_dark.png' : "/images/kawaii/icons/Listings.png" })));
};

var Icon$27 = function (props) {
    var theme = useTheme();
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 28 28" }, props),
        React__default['default'].createElement("image", { width: "28", height: "28", href: theme.isDark ? '/images/kawaii/icons/FortuneCookies_dark.png' : "/images/kawaii/icons/FortuneCookies.png" })));
};
